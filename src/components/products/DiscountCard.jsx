function DiscountCard({ discountedPrice }) {
    return (
        <div className='relative'>
            <div>
                ...
                >
                    <path
                        ...
                        fill='url(#paint0_linear_2027_87)'
                    />
                    <path
                    ...
                    <path
                        ...
                        fill='#F7B166'
                    />
                    <path d='M0 24H4V30L0 24Z' fill='url(#paint1_linear_2027_87)' />
                    <defs>
                        <linearGradient
                            id='paint0_linear_2027_87'
                            x1='53'
                            y1='24'
                            x2='-1.99253'
                            y2='17.8674'
            ...
            <div className='absolute -top-0.5 left-2'>
                <span className='text-[12px] font-[525px] text-white'>- ৳ {discountedPrice}</span>
            </div>
        </div>
    );
}
